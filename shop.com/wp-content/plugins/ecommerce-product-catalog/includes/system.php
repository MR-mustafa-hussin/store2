		...
		if ( isset( $_GET['reset_product_settings'] ) ) {
            ...
            <table class="widefat" cellspacing="0" id="ic_tools">
                ...
                <tr>
                    ...
                    <td><a class="button"
                           href="<?php echo esc_url( add_query_arg( 'reset_product_settings', 1 ) ) ?>"><?php _e( 'Reset Catalog Settings', 'ecommerce-product-catalog' ) ?></a>
                    </td>
                </tr>
                <tr>
                    <td><?php _e( 'Delete all items', 'ecommerce-product-catalog' ); ?>:</td>
                    <td><a class="button"
                           href="<?php echo esc_url( add_query_arg( 'delete_all_products', 1 ) ) ?>"><?php _e( 'Delete all Catalog Items', 'ecommerce-product-catalog' ) ?></a>
                    </td>
                </tr>
                <tr>
                    <td><?php _e( 'Delete all categories', 'ecommerce-product-catalog' ); ?>:</td>
                    <td><a class="button"
                           href="<?php echo esc_url( add_query_arg( 'delete_all_product_categories', 1 ) ) ?>"><?php _e( 'Delete all Catalog Categories', 'ecommerce-product-catalog' ) ?></a>
                    </td>
                </tr>
				<?php
				if ( get_option( 'old_sort_bar' ) == 1 ) {
                    ...
                    <tr>
                        ...
                        <td><a class="button"
                               href="<?php echo esc_url( add_query_arg( 'delete_old_filters_bar', 1 ) ) ?>"><?php _e( 'Empty Default Filters Bar', 'ecommerce-product-catalog' ) ?></a>
                        </td>
                    </tr>
				<?php } ?>
                <tr>
                    <td><?php _e( 'Delete all items and categories on uninstall', 'ecommerce-product-catalog' ); ?>:
                    </td>
                ...
                <tr>
                    <td><?php _e( 'Reassign product data', 'ecommerce-product-catalog' ); ?>:</td>
					<?php
					$info = '';
					if ( ! empty( $_GET['reassign_product_data'] ) ) {
						$info = ic_update_product_data();
					}
					$button_label = __( 'Reassign data', 'ecommerce-product-catalog' );
					if ( wp_get_schedule( 'ic_update_product_data' ) ) {
						$button_label = __( 'Speed up', 'ecommerce-product-catalog' );
					}
					$reassign_data = '<a class="button" href="' . admin_url( 'edit.php?post_type=al_product&page=system.php&reassign_product_data=1' ) . '">' . $button_label . '</a>';
            ...
            <table class="widefat" cellspacing="0" id="status">
                ...
                <tr>
                    <td><?php echo sprintf( __( '%s Database Version', 'ecommerce-product-catalog' ), IC_CATALOG_PLUGIN_NAME ); ?>
                        :
                    </td>
            ...
            <table class="widefat" cellspacing="0" id="status">
                <thead>
                <tr>
                    <th colspan="2"><?php _e( 'Active Plugins', 'ecommerce-product-catalog' ); ?>
            ...
            <table class="widefat" cellspacing="0">
				...
				<?php endif ?>
                <tr>
                    <td><?php echo sprintf( __( '%s Support', 'ecommerce-product-catalog' ), IC_CATALOG_PLUGIN_NAME ); ?>
                        :
                    </td>
                    <td><?php
