...
* <strong>Organise and structure CSV columns in the export file </strong>just as you want with the drag and drop UI.
* <strong>Rename CSV column headers</strong> as you like.
...
3. Export mapping for for WooCommerce product export plugin
